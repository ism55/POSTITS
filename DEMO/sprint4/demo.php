...
// Removing notes4 that are older than an hour:
//mysqli_query($link,"DELETE FROM notes4 WHERE id>3 AND dt<SUBTIME(NOW(),'0 1:0:0')");

//DELETE FROM `notes4` WHERE `notes4`.`id` = $id

$sql = "SELECT * FROM notes4";
...
<title>Post-Its Board: SPRINT 4</title>
...
<p class="tutInfo">Ir a <a href="../sprint3/demo.php">PÁGINA ANTERIOR</a> Ir a la  <a href="../sprint5/demo.php">PÁGINA SIGUIENTE</a>.</p>
