$(document).ready(function(){
	...
	$('.note').each(function(){
		/* Finding the biggest z-index value of the notes2 */
	...
	$('.color').live('click',function(){
		$('#fancy_ajax .note').removeClass('yellow green blue pink orange purple red').addClass($(this).attr('class').replace('color',''));
	});
	
	/* The submit button: */
	$('#note-submit').live('click',function(e){
		
		if($('.pr-body').val().length<3)
		{
