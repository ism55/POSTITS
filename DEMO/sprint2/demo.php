...
// Removing notes2 that are older than an hour:
//mysqli_query($link,"DELETE FROM notes2 WHERE id>3 AND dt<SUBTIME(NOW(),'0 1:0:0')");

//DELETE FROM `notes2` WHERE `notes2`.`id` = $id
...
<title>Post-Its Board: SPRINT 2</title>
...
<p class="tutInfo">Ir a <a href="../sprint1/demo.php">PÁGINA ANTERIOR</a> Ir a la  <a href="../sprint3/demo.php">PÁGINA SIGUIENTE</a>.</p>
</body>
