...
// Removing notes6 that are older than an hour:
//mysqli_query($link,"DELETE FROM notes6 WHERE id>3 AND dt<SUBTIME(NOW(),'0 1:0:0')");

//DELETE FROM `notes6` WHERE `notes6`.`id` = $id

$sql = "SELECT * FROM notes6";
...
<title>Post-Its Board: SPRINT 6</title>
...
<p class="tutInfo">Ir a <a href="../sprint5/demo.php">PÁGINA ANTERIOR</a></p>
</body>
