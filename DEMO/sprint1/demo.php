...
// Removing notes1 that are older than an hour:
//mysqli_query($link,"DELETE FROM notes1 WHERE id>3 AND dt<SUBTIME(NOW(),'0 1:0:0')");

//DELETE FROM `notes1` WHERE `notes1`.`id` = $id
...
<title>Post-Its Board: SPRINT 1</title>
...
<p class="tutInfo">Ir a la  <a href="../sprint2/demo.php">PÁGINA SIGUIENTE</a>.</p>
</body>
